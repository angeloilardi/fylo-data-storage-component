...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center bg-[url(/images/bg-mobile.png)] justify-center bg-cover bg-no-repeat gap-6">
      ...
      <div className="flex flex-col bg-delft_blue w-[330px] h-[180px] rounded-lg px-5 relative gap-3">
        <p className="text-sm text-center mt-10 text-delft_blue-900">
        ...
        <div className="w-[150px] h-[60px] bg-white flex justify-center rounded-md items-center absolute -bottom-[20%] left-[25%]">
